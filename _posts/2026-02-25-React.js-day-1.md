...
이 상태에서 페이스북의 엔지니어들은 코드의 유지보수 조차 어렵게 되었는데, 이는 필연적으로 업무 프로세스를 효율적으로 만드는 도구가 필요했던 것이다.   
이것이 React.js가 생기게 된 계기이다.
...
<div id="data-flow-demo">
  ...
  <div class="container">
    ...
    <div class="box" id="one-way-container">
      ...
      <div class="log" id="one-way-log">이벤트 로그가 여기에 표시.</div>
    ...
    <div class="box" id="two-way-container">
      ...
      <div class="log" id="two-way-log">이벤트 로그가 여기에 표시.</div>
